...
//				   Paragraph linebreak = new Paragraph("-------------------------------------------------------------------");
            ...
            Paragraph StatementType= new Paragraph("COMBINED STATEMENT");
...
//                       document.add(space);
    ...
    public static  PdfPTable createTable(){
        ...
        c16.setColspan(1);
        table.addCell(c16);
        PdfPCell c17 = new PdfPCell(new Phrase("(Intr)PaidOut", font));
        c17.setBackgroundColor(new BaseColor(78, 89, 0));
        c17.setColspan(1);
        table.addCell(c17);
        PdfPCell c18 = new PdfPCell(new Phrase("(Intr)PaidOut", font));
